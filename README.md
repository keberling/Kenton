...
Interactive upload site for field techs to drop project photos. GPS metadata from each image is extracted automatically, and photos are matched to job sites when they're within ~100 meters of the site address.
...
3. **Auto-match on upload** — if a job site already exists within 100m, the photo is tagged immediately.
